...
function openBasketPopUp() {
  ...
  // Nur beim Öffnen den Inhalt setzen
  if (!popUpBasketRef.classList.contains("display-none")) {
    popUpBasketRef.innerHTML = `
      <div class="popUpBasket">
        ...
        <div class="delivery-pickup-container-mobile">
  ...
  container.innerHTML += `
    <div class="finish-conatiner">
      ...
      <div class="basket-finish-btn">
        <button onclick="finishedBasketMobile()" class="finish-btn" data-text="Awesome">
